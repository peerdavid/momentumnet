...
if __name__ == "__main__":
    ...
    train_accs, train_losss, test_accs, test_losss = train_resnet(
        lr, model, init_speed=init_speed, gamma=gamma, seed=seed, save=save, mem=mem
    )
